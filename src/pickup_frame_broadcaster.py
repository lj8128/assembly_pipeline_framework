...
class PickupFrameBroadcaster:
    ...
    def __init__(self):
        ...
        new_tfs.header.frame_id = 'fiducial_12'
        ...
        while not rospy.is_shutdown():
            try:
                tf_cargo = self.tf_buffer.lookup_transform('fiducial_12', 'fiducial_12', rospy.Time()).transform
                ...
                tf_cargo_to_base_link = self.tf_buffer.lookup_transform('fiducial_12', 'px100/base_link', rospy.Time()).transform 
